...
namespace FinalThesisBackend.Migrations
{
    ...
    [Migration("20200404122336_UPDATE_CATEGORY_ADD_SORTORDER")]
    partial class UPDATE_CATEGORY_ADD_SORTORDER
    {
            ...
            modelBuilder.Entity("FinalThesisBackend.Core.Entities.ProductCollection", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 4, 4, 19, 23, 35, 968, DateTimeKind.Local).AddTicks(1670));
