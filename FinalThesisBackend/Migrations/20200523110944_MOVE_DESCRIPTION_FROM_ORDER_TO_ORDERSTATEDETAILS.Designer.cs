...
namespace FinalThesisBackend.Migrations
{
    ...
    [Migration("20200523110944_MOVE_DESCRIPTION_FROM_ORDER_TO_ORDERSTATEDETAILS")]
    partial class MOVE_DESCRIPTION_FROM_ORDER_TO_ORDERSTATEDETAILS
    {
            ...
            modelBuilder.Entity("FinalThesisBackend.Core.Entities.CustomerOrderStateDetails", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 5, 23, 18, 9, 44, 160, DateTimeKind.Local).AddTicks(1800));

                    b.Property<string>("Description")
                        .HasColumnType("nvarchar(200)")
                        .HasMaxLength(200);

                    b.HasKey("CustomerOrderId", "EmployeeId", "OrderState");
            ...
            modelBuilder.Entity("FinalThesisBackend.Core.Entities.ProductCollection", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 5, 23, 18, 9, 44, 232, DateTimeKind.Local).AddTicks(2510));
