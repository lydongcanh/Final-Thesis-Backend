...
namespace FinalThesisBackend.Migrations
{
    ...
    [Migration("20200523132739_UPDATE_ORDERSTATEDETAILS_ID")]
    partial class UPDATE_ORDERSTATEDETAILS_ID
    {
            ...
            modelBuilder.Entity("FinalThesisBackend.Core.Entities.CustomerOrderStateDetails", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 5, 23, 20, 27, 38, 393, DateTimeKind.Local).AddTicks(3600));
            ...
            modelBuilder.Entity("FinalThesisBackend.Core.Entities.ProductCollection", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 5, 23, 20, 27, 38, 456, DateTimeKind.Local).AddTicks(8140));
