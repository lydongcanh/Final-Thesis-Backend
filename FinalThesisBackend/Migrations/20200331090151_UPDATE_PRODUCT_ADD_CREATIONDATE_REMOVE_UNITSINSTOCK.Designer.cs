...
namespace FinalThesisBackend.Migrations
{
    ...
    [Migration("20200331090151_UPDATE_PRODUCT_ADD_CREATIONDATE_REMOVE_UNITSINSTOCK")]
    partial class UPDATE_PRODUCT_ADD_CREATIONDATE_REMOVE_UNITSINSTOCK
    {
            ...
            modelBuilder.Entity("FinalThesisBackend.Core.Entities.ProductCollection", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 3, 31, 16, 1, 50, 973, DateTimeKind.Local).AddTicks(7490));
