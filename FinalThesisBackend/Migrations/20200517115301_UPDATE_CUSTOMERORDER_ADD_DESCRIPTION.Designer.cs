...
namespace FinalThesisBackend.Migrations
{
    ...
    [Migration("20200517115301_UPDATE_CUSTOMERORDER_ADD_DESCRIPTION")]
    partial class UPDATE_CUSTOMERORDER_ADD_DESCRIPTION
    {
            ...
            modelBuilder.Entity("FinalThesisBackend.Core.Entities.ProductCollection", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 5, 17, 18, 53, 1, 353, DateTimeKind.Local).AddTicks(9440));
