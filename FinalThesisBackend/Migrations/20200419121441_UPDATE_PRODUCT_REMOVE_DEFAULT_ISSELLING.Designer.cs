...
namespace FinalThesisBackend.Migrations
{
    ...
    [Migration("20200419121441_UPDATE_PRODUCT_REMOVE_DEFAULT_ISSELLING")]
    partial class UPDATE_PRODUCT_REMOVE_DEFAULT_ISSELLING
    {
            ...
            modelBuilder.Entity("FinalThesisBackend.Core.Entities.ProductCollection", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 4, 19, 19, 14, 40, 542, DateTimeKind.Local).AddTicks(2580));
