...
namespace FinalThesisBackend.Migrations
{
    ...
    [Migration("20200710191521_UPDATE_PRODUCT_ADD_DISCOUNT_FIELDS")]
    partial class UPDATE_PRODUCT_ADD_DISCOUNT_FIELDS
    {
            ...
            modelBuilder.Entity("FinalThesisBackend.Core.Entities.CustomerOrderStateDetails", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 7, 11, 2, 15, 21, 149, DateTimeKind.Local).AddTicks(163));
            ...
            modelBuilder.Entity("FinalThesisBackend.Core.Entities.ProductCollection", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 7, 11, 2, 15, 21, 171, DateTimeKind.Local).AddTicks(9523));
