...
namespace FinalThesisBackend.Migrations
{
    ...
    [Migration("20200520143904_ADD_CUSTOMERORDERSTATEDETAILS")]
    partial class ADD_CUSTOMERORDERSTATEDETAILS
    {
            ...
            modelBuilder.Entity("FinalThesisBackend.Core.Entities.CustomerOrderStateDetails", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 5, 20, 21, 39, 4, 188, DateTimeKind.Local).AddTicks(5610));
            ...
            modelBuilder.Entity("FinalThesisBackend.Core.Entities.ProductCollection", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 5, 20, 21, 39, 4, 261, DateTimeKind.Local).AddTicks(8610));
